...
class Predict():
    def __init__(self, config, model_path='./runs/1551149033/checkpoints/model-9700', word_to_index='./vocabs/word_to_index.json',
...
if __name__ == '__main__':
    ...
    result = prediction.predict(
        ["""贝壳首席经济学家、贝壳研究院院长杨现领在北京指出，因城镇化进程带来的区域人口变动将使得中国房地产有最后一波增量红利，同时“房住不炒”将是未来很长一段时间内的政策底线。""",
         """黄蜂vs湖人首发：科比带伤战保罗 加索尔救赎之战 新浪体育讯北京时间4月27日，NBA季后赛首轮洛杉矶湖人主场迎战新奥尔良黄蜂，此前的比赛中，双方战成2-2平，因此本场比赛对于两支球队来说都非常重要，赛前双方也公布了首发阵容：湖人队：费舍尔、科比、阿泰斯特、加索尔、拜纳姆黄蜂队：保罗、贝里内利、阿里扎、兰德里、奥卡福""",
